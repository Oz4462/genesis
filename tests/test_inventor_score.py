...
def test_goal_has_five_axes():
    # INVENTION_GOAL is the proxy (5-axis for inventor); bridged to full γ+ ParetoFront/derive/RunState in loop.py
    # (see also test_gamma_plus_bridge_in_loop... + score.py bridge comments)
