...
void Decay_function_initSynchronous(DATA *data, threadData_t *threadData)
{
...
/* Update base-clock. */
void Decay_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
...
int Decay_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  int ret;
...
/* %v% = pre(%v%)*/
void Decay_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
}
