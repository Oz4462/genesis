...
def auto_place_components(
    components: list[Component],
    board_dims: tuple[float, float] = (150.0, 100.0),
    *,
    ...
    row_h = 22.0
    col_w = 28.0
    hot_x = margin + 10.0  # thermal edge priority
    x = margin
    y = margin
...
def route_harness(
    ...
    *,
    ...
    for seg in harness.segments:
        ...
        gauge_ok = seg.gauge_mm2 >= max(0.5, seg.current_a / 12.0)  # rough 12A/mm2 rule
