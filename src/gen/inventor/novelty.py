...
async def assess_novelty(
    ...
    *,
    ...
    For consistency with Inventor step ❶, pass the exact same backends that were used for frontier_context
    (i.e. domain.prior_art_sources()). This ensures generate sees the frontier and novelty measures against it.
    """
