...
# costing/export seam (pipelines Step 8-9): estimate_fdm_cost -> manufacturing_check:246 (cost_estimate + stub summary) -> fertigungs:127 (_fdm_cost_estimate_from_dfm pulls summary) + integrator:244 (cost_hint).
# Complements separate costing.py bom_cost (material only for priced/fabricated, used in export/markdown:111, seams ε:231, bundle, cli).
# Never fabricate point value; ranged + assumptions/gaps explicit (L1-4). Used in tests + real CAD vol from prototype.
