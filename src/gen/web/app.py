...
def _assessment_dict(a: Assessment) -> dict:
    return {
        ...
        "completeness_warnings": a.completeness_warnings,
        "seam_certificate": (
            {
                "spec_run_id": a.seam_certificate.spec_run_id,
                "has_seams": bool(a.seam_certificate.seams),
                "num_seams": len(a.seam_certificate.seams),
                "complete": a.seam_certificate.complete,
                "produced_by": a.seam_certificate.produced_by,
            }
            if a.seam_certificate is not None
            else None
        ),
        "memory_fabric": (
            {
                "run_id": a.memory_fabric.run_id,
                "has_deposits": bool(a.memory_fabric.deposits),
