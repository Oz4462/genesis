...
""")
    ...
    def integrate_into_aethon(
        ...
        *,
        ...
        """
        from .genesis_humanoid import AETHON as BASE_AETHON, build_aethon
    ...
    while True:
        ...
        try:
            ...
            if any(k in lowered for k in ["evolve", "mehr", "evolution"]):
                ...
                response = "Resurrection run: improvements in long loop, see STATUS.md and report update. Use chat 'long background' for full."
                print(f"[GENESIS] {response}")
                ...
                try:
                    ...
                    response = "[Genesis Dream] Hammer triggered. Deciding actions..."
