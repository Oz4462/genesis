...
from . import aethon_hydraulics  # explicit wire for AETHON completeness (core hydraulics option vs electric; ensures not listed as island)
...
SHELLS_DIR = REPRO_SHELLS_DIR if Path(REPRO_SHELLS_DIR).is_dir() else MAIN_SHELLS_DIR
