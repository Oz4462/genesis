...
This package brings seven real open-source humanoids (TienKung, Berkeley Humanoid Lite, Asimov v1,
AGILOped, Fourier N1, K-Scale K-Bot, InMoov) in as GROUND-TRUTH reference data and runs GENESIS's own
closed-form physics axes against their PUBLISHED specs — calibrating and proving GENESIS's humanoid
physics on real designs rather than only on its own generated robots.
