...
E2E usage (HORIZON elaboration): first call site wired guarded in grenzverschiebung/lumencrucible.py:process_dream (via FalsificationExperiment/Measurement import + evaluate_reality + gate_delta_plus + reviewed in coverage). See LUMEN attach block + test_lumencrucible.
"""
